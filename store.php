...
$query_prod = sprintf("SELECT * FROM products WHERE category = %s ORDER BY id DESC", GetSQLValueString($colname_prod, "text"));
...
<div class="panel panel-right panel-cover"> 
      <div class="user_login_info">
         <nav class="user-nav">
            ...
            <ul>
              <li><a href="store.php?category=couples" class="external"><span>Couples</span></a></li>
              <li><a href="store.php?category=pioneers" class="external"><span>Pioneers</span></a></li>
              <li><a href="store.php?category=music" class="external"><span>Music</span></a></li>
              <li><a href="store.php?category=sunday"class="external"><span>Sunday Service</span></a></li>
              <li><a href="store.php?category=mentorship" class="external"><span>Mentorship</span></a></li>
              <li><a href="store.php?category=leaders" class="external"><span>Leaders seminar</span></a></li>

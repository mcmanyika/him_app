              ...
              <div class="post_single">
                <div class="featured_image">
                  <div class="page_content">
                   <div class="blog-posts" style="background-color: #000000; opacity: 0.6; color:#ffffff; !important">
                    <span style="font-size: 16px">
                      <strong style="font-size: 20px; color:#ffffff;"><?php echo $row_DetailRS1['title']; ?></strong><br /><br />
                      <?php echo $row_DetailRS1['description']; ?></span><br />
                      <span style="font-size: 16px; padding-top: 20px"><strong><?php echo $row_DetailRS1['writer']; ?>
                      </strong></span>
                  </div>
              </div>
             </div>

...
$query_raw = "SELECT * FROM devotions ORDER BY id desc";
...
<h2 class="page_title">Daily Devotions</h2>
              <ul class="posts">
             
 <?php do { ?>
                <li>
                    <div class="post_entry">
                        <div class="post_title" style="color:#f5f5f5">
                        <strong><a href="devotions-single.php?recordID=<?php echo $row_raw['id']; ?>" style="color:#f5f5f5"><?php echo $row_raw['title']; ?></a></strong><br />
                          <?php echo $row_raw['date']; ?>
                        </div>
                    </div>
                </li>

...
$query_raw = "SELECT * FROM itenerary ORDER BY id desc";
     ...
     <div id="pages_maincontent">
       ...
       <div class="page_content">
            <div class="blog-posts" style="background-color: #000000; opacity: 0.6;">
             <h2 class="page_title">Itenerary</h2>
              <ul class="posts">
              <?php do { ?>
                <li>
                    <div class="post_entry">
                        <div class="post_date">
                            <span class="day"><?php echo $row_raw['day']; ?></span>
                            <span class="month"><?php echo $row_raw['month']; ?></span>
                        </div>
                        <div class="post_title">
                        <h2 style="color:#ffffff"><?php echo $row_raw['venue']; ?></h2>
                        </div>
                    </div>
                </li>
